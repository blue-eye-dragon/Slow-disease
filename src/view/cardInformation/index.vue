              ...
              <el-row>
                  <el-col :span="24">
                    <el-form-item label="人群分类：">
                      <el-radio-group v-model="form.peopleType" class="alignGrounp">
                        <el-radio v-for="item in peopleTypeList" :label="item.value" :key="item.value">{{item.label}}</el-radio> 
                      </el-radio-group> 
                      <el-input style="width: 300px;" v-if="form.peopleType == 19" v-model="form3.peopleTypeOther" placeholder="请输入内容"></el-input>
                    </el-form-item>
                  </el-col>
              </el-row>
              <el-row>
      ...
      <el-tab-pane label="传染病页二" name="second">
        <div style="padding:20px">
          <el-form ref="form2" :model="form2" label-width="100px" class="formBorder">
              ...
              <el-col :span="24">
                <el-form-item label="甲类传染病：">
                  <el-radio-group v-model="form2.contagionA">
                    <el-radio v-for="item in contagionAList" :label="item.value" :key="item.value">{{item.label}}</el-radio>
                  </el-radio-group>
                </el-form-item>
              </el-col>
            </el-row>
            ...
            <el-row>
              <el-col :span="24">
                <el-form-item label="丙类传染病：">
                  <el-radio-group v-model="form2.contagionC" class="alignGrounp">
                    <el-radio v-for="item in contagionCList" :label="item.value" :key="item.value">{{item.label}}</el-radio>
                  </el-radio-group>
                </el-form-item>
              </el-col>
            </el-row>
            <el-row>
              <el-col :span="24">
                <el-form-item label="其他法定管理以及重点监测传染病：" label-width="240px">
            ...
            <el-row>
              <el-col :span="24">
                <el-form-item label="密切接触者有无相同症状：" label-width="185px">
            ...
            <el-row>
              <el-col :span="12">
                <el-form-item label="订正病名：" label-width="85px">
                  <el-input v-model="form.otherContagion" placeholder="请输入内容"></el-input>
                </el-form-item>
                <el-form-item label="报告单位：" label-width="85px">
                  <el-input v-model="form.otherContagion" placeholder="请输入内容"></el-input>
                </el-form-item>
                <el-form-item label="报告医生：" label-width="85px">
                  <el-input v-model="form.otherContagion" placeholder="请输入内容"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="退卡原因：" label-width="85px">
                  <el-input v-model="form.otherContagion" placeholder="请输入内容"></el-input>
                </el-form-item>
            ...
            <el-row>
              <el-col :span="24">
                <el-form-item label="备注：" label-width="60px">
                  <el-input type="textarea" :rows="2" placeholder="请输入内容" v-model="form2.note"></el-input>
                </el-form-item>
              </el-col>
            </el-row>
          </el-form>
        ...
        <div style="padding:20px"> 
          <el-form ref="form" :model="form3" label-width="85px" style="border:1px solid;paddingTop: 20px">
              <el-row>
                  <el-col :span="6">
                    <el-form-item label="患者姓名：">
                      <el-input v-model="form3.name" placeholder="请输入患者姓名"></el-input>
                    </el-form-item>
                  </el-col>
                  <el-col :span="8">
                    <el-form-item label="( 患儿家长姓名 )：" label-width="130px">
                      <el-input v-model="form3.parentsName" placeholder="请输入患儿家长姓名"></el-input>
                    </el-form-item>
                  </el-col>
                  <el-col :span="5">
                    <el-form-item label="性别：">
              ...
              <el-row>
                  <el-col :span="8">
                    <el-form-item label="有效证件号：" label-width="100px">
                      <el-input v-model="form3.idcard" placeholder="请输入有效证件号"></el-input>
                    </el-form-item>
                  </el-col>
                  <el-col :span="6">
                    <el-form-item label="证件类型：">
                        <el-select v-model="form3.idcardType" placeholder="请选择">
                          <el-option label="身份证" :value="1"></el-option>
                          <el-option label="社保卡" :value="2"></el-option>
                          <el-option label="其他" :value="3"></el-option>
                        </el-select>
                      <el-input style="width: 300px;" v-if="form3.idcardType == 3" v-model="form3.idcardTypeOther" placeholder="请输入内容"></el-input>
                    </el-form-item>
                  </el-col>
              </el-row>
              <el-row>
                  <el-col :span="8">
                    <el-form-item label="实足年龄：">
                      <el-input v-model="form3.age" placeholder="请输入年龄"></el-input>
                    </el-form-item>
                  </el-col>
                  <el-col :span="5">
                    <el-form-item label="年龄单位：">
                      <template>
                        <el-select v-model="form3.ageType" placeholder="请选择">
                          <el-option
                            v-for="item in option"
                            :label="item.label"
                            :value="item.value"
              ...
              <el-row>
                  <el-col :span="10">
                    <el-form-item label="新生儿等填写出生日期：" label-width="170px">
                      <el-date-picker
                  ...
                  <el-col :span="7">
                    <el-form-item label="孕妇怀孕（周）：" label-width="170px">
                      <el-input-number v-model="form3.num" controls-position="right" @change="handleChange" :min="1" :max="50"></el-input-number>
                    </el-form-item>
                  </el-col>
              </el-row>
              <el-row>
              ...
              <el-row>
                ...
                <el-col :span="6">
                  <el-form-item label="精确到门牌号：" label-width="130px">
                    <el-input v-model="form3.doorId" placeholder="请输入门牌号"></el-input>
                  </el-form-item>
                </el-col>
              </el-row>
              <el-row>
                  ...
                  <el-col :span="8">
                    <el-form-item label="联系电话：">
                      <el-input v-model="form3.iphone" placeholder="请输入内容"></el-input>
                    </el-form-item>
                  </el-col>
              </el-row>
              <el-row>
                  <el-col :span="24">
                    <el-form-item label="患者职业：">
                      <el-radio-group v-model="form3.patientsType" class="alignGrounp">
                        <el-radio v-for="item in patientsTypeList" :label="item.value" :key="item.value">{{item.label}}</el-radio> 
                      </el-radio-group>
                      <el-input style="width: 300px;" v-if="form3.patientsType == 20" v-model="form3.patientsTypeOther" placeholder="请输入内容"></el-input>
                    </el-form-item>
                  </el-col>
              </el-row>
              <el-row>
              ...
              <el-row>
                  <el-col :span="24">
                    <el-form-item label="疾病名称：">
                      <el-radio-group v-model="form4.diseaseName" class="alignGrounp">
                        <el-radio v-for="item in diseaseNameList" :label="item.value" :key="item.value">{{item.label}}</el-radio>
                      </el-radio-group>
                      <el-input style="width: 300px;" v-if="form4.diseaseName == 12" v-model="form4.diseaseNameOther" placeholder="请输入内容"></el-input>
                    </el-form-item>
                  </el-col>
              </el-row>
              <el-row>
                <el-col :span="24">
                  ...
                  <el-col :span="24">
                    <el-form-item label="滴度：" label-width="55px">
                  ...
                  <el-col :span="24">
                    ...
                    <el-form-item label="19S-IgM-TPPA：" label-width="125px">
                  ...
                  <el-col :span="24">
                    <el-form-item label="项目：" label-width="55px">
                      ...
                      <el-input style="width: 300px;margin-left:30px" v-if="form4.gonorrhoeaSub == 3" v-model="form4.onorrhoeaSubOther" placeholder="请输入内容"></el-input>
                    </el-form-item>
                    <el-form-item label="结果：" label-width="55px">
                ...
                <el-col :span="24">
                  ...
                  <el-col :span="24">
                    <el-form-item label="1、梅毒：" >
                      ...
                      <el-input style="width: 250px;margin-left:30px" v-if="form4.syphilisSymptoms == 9" v-model="form4.syphilisSymptomsOther" placeholder="请输入内容"></el-input>
                    </el-form-item>
                    <el-form-item label="2、淋病：">
                      ...
                      <el-input style="width: 300px;margin-left:30px" v-if="form4.gonorrheaSymptoms == 7" v-model="form4.gonorrheaSymptomsOther" placeholder="请输入内容"></el-input>
                    </el-form-item>
                  </el-col>
                </el-col>
              </el-row>
                ...
                <el-col :span="24">
                  ...
                  <el-col :span="24">
                    <el-form-item label="1、梅毒：" >
                      ...
                      <el-input style="width: 300px;margin-left:30px" v-if="form4.syphilisMedicine == 4" v-model="form4.syphilisMedicineOther" placeholder="请输入内容"></el-input>
                    </el-form-item>
                    <el-form-item label="2、淋病：">
                      ...
                      <el-input style="width: 300px;margin-left:30px" v-if="form4.gonorrheaMedicine == 4" v-model="form4.gonorrheaMedicineOther" placeholder="请输入内容"></el-input>
                    </el-form-item>
                  </el-col>
                  <el-col :span="8">
                    <el-form-item label="报告单位：">
                      <el-input v-model="form4.reporting" placeholder="请输入内容"></el-input>
                    </el-form-item>
                    <el-form-item label="订正病名：">
                      <el-input v-model="form4.revisedName" placeholder="请输入内容"></el-input>
                    </el-form-item>
                  </el-col>
                  <el-col :span="8">
                    <el-form-item label="报告医生：">
                      <el-input v-model="form4.reportingDoctor" placeholder="请输入内容"></el-input>
                    </el-form-item>
                    <el-form-item label="备注：" label-width="60px">
                      <el-input v-model="form4.remark" placeholder="请输入内容"></el-input>
                    </el-form-item>
                  </el-col>
                  <el-col :span="8">
                    <el-form-item label="填卡日期：">
                      <el-date-picker v-model="form4.fillingDate" type="date" placeholder="选择日期"></el-date-picker>
                    </el-form-item>
                    <el-form-item label="收卡日期：">
                      <el-date-picker v-model="form4.collectionDate" type="date" placeholder="选择日期"></el-date-picker>
                    </el-form-item>
                  </el-col>
                </el-col>
              </el-row>
